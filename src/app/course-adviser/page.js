  ...
  return (
    <main  className='bg-[#FEFEFE    w-screen'>
        <div className="header border-b  p-5 border-[#EAEAEA] flex w-full items-center justify-between">
            ...
            <div className=" mr-3">
              <CgProfile color='#3a3a3a' size={36} cl/>
            </div>
            <div className=""><CgMenuRight color='#3a3a3a' size={36}/></div>
        </div>
        ...
        <section id="course-adviser-dashboard" className='px-5'>
          ...
          <div className="scroll-container overflow-auto">
            <div className="course-adviser-actions flex w-[200vw] overflow-x-scroll text-[0.79rem] mt-10">
                <div className="card1 bg-slate-900 text-white h-[20vh] w-[55%] flex justify-between px-5 rounded items-center border mr-8">
                ...
                <div className="card2 bg-slate-900 text-white h-[20vh] w-[55%] flex justify-between px-5 rounded items-center border mr-8">
                  <div className="justify-self-start text-left">
                ...
                <div className="card3 bg-slate-900 text-white h-[20vh] w-[55%] flex justify-between px-5 rounded items-center border mr-8">
                  <div className="justify-self-start text-left">
